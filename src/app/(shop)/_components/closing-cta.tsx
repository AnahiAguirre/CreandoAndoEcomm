...
export function ClosingCta() {
  return (
    <section className="flex flex-col items-center justify-center gap-7 bg-tinta px-4 py-32 text-center text-white md:h-[560px] md:py-0">
      ...
      <p className="scroll-rise-late text-lg text-tinta-muted md:text-2xl">Juguetes de madera e imprimibles para colorear.</p>
      <div className="scroll-rise-late flex flex-wrap items-center justify-center gap-x-7 gap-y-3 text-[19px]">
